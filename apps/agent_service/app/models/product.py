...
class Product(Base):
    ...
    marketplace_scrapes: Mapped[list["MarketplaceScrape"]] = relationship(back_populates="product")
    competitor_tiers: Mapped[list["CompetitorTier"]] = relationship(back_populates="product")
