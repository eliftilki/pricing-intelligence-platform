...
class SearchRequest(BaseModel):
    ...
    # Kulaklik/mouse/klavye: connection_type. Telefon: ram_gb / storage_gb /
    # sim_type. Klavye: keyboard_layout.
    connection_type: Optional[Literal["kablolu", "kablosuz"]] = None
    ram_gb: Optional[int] = None
    storage_gb: Optional[int] = None
    sim_type: Optional[Literal["tek_hat", "cift_hat"]] = None
    keyboard_layout: Optional[Literal["TR Q", "TR F", "US Q", "UK Q"]] = None
...
class SearchAndRunRequest(BaseModel):
    ...
    query: str
    marketplaces: List[str] = Field(default_factory=lambda: ["trendyol", "hepsiburada", "amazon"])
    # Kulaklik/mouse/klavye fiyatini buyuk olcude degistiren varyant secimleri
    # (bkz. SearchRequest). search_and_run kayit yaptigi icin bu bilginin
    # kaybolmamasi onemli - aksi halde dogru olmayan bir varyant takip edilir.
    connection_type: Optional[Literal["kablolu", "kablosuz"]] = None
    keyboard_layout: Optional[Literal["TR Q", "TR F", "US Q", "UK Q"]] = None
