...
const notifications = [
  {
    title: "Bildirim merkezi hazir",
    description:
      "Veri toplama, analiz ve fiyat onerisi durumlari burada gosterilecek.",
    meta: "Sistem",
  },
];
  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute -right-[240px] mt-[17px] flex w-[350px] flex-col rounded-lg border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0"
      >
          ...
          {notifications.map((notification) => (
            ...
            >
              <div className="flex gap-3">
                <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-brand-50 text-brand-500 dark:bg-brand-500/15 dark:text-brand-300">
                  <svg
                    width="18"
                    height="18"
                    viewBox="0 0 20 20"
